...
if (rst_i)
    wr_data_q <= 32'b0;
else if (cfg_wvalid_i)
    wr_data_q <= cfg_wdata_i;

//-----------------------------------------------------------------
// Request Logic
//-----------------------------------------------------------------
wire read_en_w  = cfg_rvalid_i;
wire write_en_w = cfg_wvalid_i;
...
wire usb_ep0_data_rd_req_w = read_en_w & (cfg_addr_i[7:0] == `USB_EP0_DATA);
wire usb_ep1_data_rd_req_w = read_en_w & (cfg_addr_i[7:0] == `USB_EP1_DATA);
wire usb_ep2_data_rd_req_w = read_en_w & (cfg_addr_i[7:0] == `USB_EP2_DATA);
wire usb_ep3_data_rd_req_w = read_en_w & (cfg_addr_i[7:0] == `USB_EP3_DATA);
